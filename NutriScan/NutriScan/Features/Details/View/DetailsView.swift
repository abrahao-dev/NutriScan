...
class DetailsView: UIView {
    ...
    private func setupLayout() {
        ...
        NSLayoutConstraint.activate([
            ...
            scoreImageView.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 200),
            scoreImageView.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -200),
